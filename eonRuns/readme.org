...
#+end_src
** Regenerating plots
A ~nu~ based parallel helper regenerates 2D plots much faster than going through
Snakemake repeatedly.
#+begin_src bash
export GITROOT=$(git rev-parse --show-toplevel)
cd "${GITROOT}/eonRuns"
nu "${GITROOT}/scripts/regen_plots.nu"
# Optional: wipe older 2D plots
cd "${GITROOT}/eonRuns/results/04_plots"
find . -type f -name "2D_rmsd.png" -delete
#+end_src
** References
#+begin_quote
